# -*- coding: utf-8 -*-
"""
Created on Sat Aug  5 18:08:20 2023
...
############################################################
'''
   GBDT-2.py defines a function: predict_Tm() to calculate 
   the Tm value. If a large amount of input data is required 
   for calculation, refer to GBDT-2_fast.py
'''
############################################################
...
model_path = 'GBDT_models\gbdt-2.pkl'
model = joblib.load(model_path)

def predict_tm(year, doy, hour, lat, lon, h, temp):
    """
...
def main():
    ...
    # Predict Tm
    predicted_tm = predict_tm(year, doy, hour, lat, lon, h, temp)
